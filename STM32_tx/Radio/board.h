...
#define RADIO_RESET                                 PC_4          // changed from PA_2  - PK

#define RADIO_MOSI                                  PA_7
#define RADIO_MISO                                  PA_6
#define RADIO_SCLK                                  PA_5
#define RADIO_NSS                                   PB_6		// changed from PB0 - PK

#define RADIO_DIO_0                                 PB_1
#define RADIO_DIO_1                                 PB_10
#define RADIO_DIO_2                                 PB_11
#define RADIO_DIO_3                                 PB_12        // changed from PB7 to avoid collision with I2C1 interface - PK
